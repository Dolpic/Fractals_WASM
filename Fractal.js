class Fractal{
    ...
    set_parameters(dimensions=[800,800], position=[0, 0], zoom = 200, iterations = 300){
      ...
      if(this.canvas.width != this.img_width || this.canvas.height != this.img_height){
    ...
    get_next_chunk(){
      ...
      const chunk_y = Math.floor(this.current_chunk/this.nb_chunk_height)
